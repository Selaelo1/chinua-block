...
const steps = [
  {
    ...
    description:
      "Sign up with your mobile number and complete a simple KYC process",
    icon: UserPlus,
  },
  {
    title: "Fund Your Wallet",
    description:
      "Deposit funds using M-Pesa, bank transfer, or other local payment methods",
    icon: Wallet,
  },
  {
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
            {steps.map((step) => (
              <div key={step.title} className="relative">
                ...
                <div className="absolute top-12 right-0 h-0.5 w-full bg-blue-100" />
